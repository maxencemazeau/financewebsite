    ...
    const features = [
        {
            icon:
                ...
                <svg fill="#60a5fa" className="w-8 h-8" viewBox="0 0 32 32" data-name="Layer 12" id="Layer_12" xmlns="http://www.w3.org/2000/svg">
